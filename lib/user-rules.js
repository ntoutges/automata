...
// sand
{
    ...
    rules.push(new SequenceRule([
        new QuantumRule([
            new MovementRule(new SpatialRule(new Matrix(4, 2, new PatternSet([]), new PatternSet([sand]), new PatternSet([air]), new PatternSet([air]), new PatternSet([]), new PatternSet([sand]), new PatternSet([air]), new PatternSet([])), new Matrix(4, 2, new PatternSet([]), new PatternSet([air]), new PatternSet([]), new PatternSet([]), new PatternSet([]), new PatternSet([]), new PatternSet([sand]), new PatternSet([]))), 1, 0, 2, 1),
            new MovementRule(new SpatialRule(new Matrix(3, 2, new PatternSet([air]), new PatternSet([sand]), new PatternSet([]), new PatternSet([air]), new PatternSet([sand]), new PatternSet([])), new Matrix(3, 2, new PatternSet([]), new PatternSet([air]), new PatternSet([]), new PatternSet([sand]), new PatternSet([]), new PatternSet([]))), 1, 0, 0, 1)
        ]),
        new MovementRule(new SpatialRule(new Matrix(3, 2, new PatternSet([]), new PatternSet([sand]), new PatternSet([air]), new PatternSet([]), new PatternSet([sand]), new PatternSet([air])), new Matrix(3, 2, new PatternSet([]), new PatternSet([air]), new PatternSet([]), new PatternSet([]), new PatternSet([]), new PatternSet([sand]))), 1, 0, 2, 1),
    ]));
}
