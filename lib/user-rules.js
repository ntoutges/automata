...
import { Pattern, PatternAddative, PatternKeyed, PatternRange, PatternRangeMonochrome } from "./patterns.js";
import { NegatedPatternSet, PatternSet } from "./rule-patterns.js";
import { MovementRule, QuantumRule, SequenceRule, SpatialRule, SurroundingRule } from "./rules.js";
...
// sand
{
    ...
    const allDeleters = new PatternRange(deleter, new Pattern(new RGB(230, 255, 40)));
    const delAdd = new Pattern(new RGB(0, 1, 0));
    ...
    rules.push(new MovementRule(new SpatialRule(new Matrix(1, 2, new PatternSet([sand]), new PatternSet([air])), new Matrix(1, 2, new PatternSet([air]), new PatternSet([sandStone]))), 0, 0, 0, 1));
    ...
    rules.push(new SpatialRule(new Matrix(2, 2, new PatternSet([]), new PatternSet([]), new PatternSet([]), new PatternSet([allDeleters])), new Matrix(3, 3, new PatternSet([air]), new PatternSet([air]), new PatternSet([air]), new PatternSet([air]), new PatternSet([]), new PatternSet([air]), new PatternSet([air]), new PatternSet([air]), new PatternSet([air]))));
    rules.push(new SurroundingRule({
    ...
    rules.push(new SpatialRule(new Matrix(1, 1, new PatternSet([new Pattern(new RGB(230, 255, 40))])), new Matrix(1, 1, new PatternSet([stone]))));
