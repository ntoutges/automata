...
export class Tileable extends Element {
    ...
    alertClickListeners(tile) { this.clickListeners.forEach(listener => listener(tile)); }
    ...
    constructor({ cols, rows, padding = 1, looping = false, doAnimations = false }) {
        ...
        this.draggable = new Draggable({
            ...
            onClick: (e) => {
                ...
                if (tile)
                    this.alertClickListeners(tile);
            },
            onUnClick: (e) => { this.alertUnClickListeners(); },
